...
/* @var $model pravda1979\core\searches\BackupAttributeSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="backup-attribute-search">
    <div class="modal fade backup-attribute-modal-dialog search-modal-dialog" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title"><?= Yii::t('BackupAttribute', 'Search') ?></h4>
                </div>
