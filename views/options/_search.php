...
/* @var $model pravda1979\core\searches\OptionsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="options-search">
    <div class="modal fade options-modal-dialog search-modal-dialog" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title"><?= Yii::t('Options', 'Search') ?></h4>
                </div>
